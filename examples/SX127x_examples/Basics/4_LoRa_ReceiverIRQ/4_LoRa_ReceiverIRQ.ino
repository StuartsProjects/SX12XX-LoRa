...
/*******************************************************************************************************
  ...
  This program does not need the DIO0 pin on the LoRa device connected.
  ...
  3s  LoRa 00005,RSSI,-39dBm,SNR,13dB,Length,11,Packets,5,Errors,0,IRQreg,50
...
void loop()
{
  ...
  if (RXPacketL == 0)                            //if the LT.receiveIRQ() function detects an error RXpacketL is 0
  {
    packet_is_Error();
  }
  else
