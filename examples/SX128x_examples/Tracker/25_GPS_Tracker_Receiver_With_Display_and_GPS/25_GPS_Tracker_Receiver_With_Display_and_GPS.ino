...
/*******************************************************************************************************
  ...
  Latitude, Longitude, Altitude, HDOP, GPS Fixtime, Number of received packets, Distance
  ...
  GPS Fixtime, Distance and direction to tracker, Tracker battery mV, Packet RSSI, Number of received packets,
  Packet length, IRQ status.
