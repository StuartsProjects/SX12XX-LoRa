/*******************************************************************************************************
  lora Programs for Arduino - Copyright of the author Stuart Robinson - 16/01/20
...
void setup()
{
  ...
  pinMode(VCCPOWER, OUTPUT);                    //for external devices, lora and SD card
  digitalWrite(VCCPOWER, LOW); 
