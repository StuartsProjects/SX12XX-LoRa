...
/*******************************************************************************************************
  ...
  power used and the packet length. The matching receive program, '4_LoRa_Receiver' can be used to check
  the packets are being sent correctly, the frequency and LoRa settings used must be the same for the
  Transmit and Receive programs. Sample Serial Monitor output;
