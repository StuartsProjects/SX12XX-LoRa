/*******************************************************************************************************
  Programs for Arduino - Copyright of the author Stuart Robinson - 10/02/22
...
/*******************************************************************************************************
  ...
  from the SX126X library to send a file from the SD card on one Arduino to the SD card on another Arduino.
  ...
  'Data transfer packet definitions.md' in the \SX126X_examples\DataTransfer\ folder.
