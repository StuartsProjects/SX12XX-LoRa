...
#define LORA_DEVICE DEVICE_SX1280               //this is the LoRa device we are using
...
const uint32_t ACKsegtimeoutmS = 250;           //mS to wait for receiving an ACK before re-trying transmit segment
