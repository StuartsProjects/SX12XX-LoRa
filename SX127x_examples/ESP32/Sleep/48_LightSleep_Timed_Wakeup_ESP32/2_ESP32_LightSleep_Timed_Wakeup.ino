...
/*
********************************************************************************************************************************
Program operation - The program flashes a LED connected to the pin defined by LED1, and puts the ESP32 to light_sleep for a
period determined by TIME_TO_SLEEP (in seconds).

 Current in light_sleep mode with a bare bones ESP32 was 2322uA
********************************************************************************************************************************
*/
