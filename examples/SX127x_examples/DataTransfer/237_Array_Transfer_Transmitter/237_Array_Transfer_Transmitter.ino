...
/*******************************************************************************************************
  ...
  the contents of an memory array on one Arduino to the SD card as a file on another Arduino, Arduino
  DUEs were used for the test. For this example the memory array is first loaded from an SD file.
  ...
  with data from a file /$50SAT_Small.JPG or /$50SAT_Tiny.JPG in this example and the array is then sent as a
  sequence of segments, similar to the way a file would be read from SD and sent.
...
void printLocalFileDetails()
{
  ...
  Serial.print(DTfilenamebuff);
  Serial.print(" Array to send CRC is 0x");
...
//***********************************************************************************************
// End Code for transfer of array
//***********************************************************************************************
...
void setup()
{
  ...
  Serial.println();
  Serial.println(F("237_Array_Transfer_Transmitter starting"));
  Serial.flush();
