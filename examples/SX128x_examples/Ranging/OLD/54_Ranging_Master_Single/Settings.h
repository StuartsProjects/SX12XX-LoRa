...
const uint16_t Calibration = 11000;              //Manual Ranging calibrarion value
...
const uint16_t  packet_delaymS = 2000;            //forced extra delay in mS between ranging requests
...
#define ENABLEDISPLAY                            //remove this define to not use display  
