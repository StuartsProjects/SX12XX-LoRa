...
//**************************************************************************************************
// 9) Display settings - Choose which display and screens to use
//    This way of setting choosing which display to use, may seem to be a bit convoluted but it does
//    make it easy to change the display used (with different row and column capability) without
//    needing to alter the main sketch.  
//**************************************************************************************************


//#define Screens_Library "ScreensSSD1306.h"           
#define Screens_Library "ScreensILI9341.h"          
...
#define DISP_CS 43                          //pins used by ILI9341 display
#define DISP_RESET 42                       //pins used by ILI9341 display
#define DISP_DC 45                          //pins used by ILI9341 display
