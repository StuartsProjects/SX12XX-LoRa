...
/*******************************************************************************************************
  ...
  With this example and the matching receiver program, 218_Reliable_Receiver_Data_Requestor, the
...
void setup()
{
  Serial.begin(115200);
  Serial.println();
  Serial.println(F("217_Reliable_Transmitter_Data_Requestor Starting"));
