...
const char LocationPacket = 'L';        //LT library tracker location packet
const char ShortLocationPacket = 'S';   //LT library tracker short version location packet 
const char LocationBinaryPacket = 's';  //Short search packet
