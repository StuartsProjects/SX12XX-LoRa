...
void loop()
{
  ...
  for (index = 1; index <= range_count; index++)
  {
    ...
    LT.transmitRanging(ranging_address, TXtimeoutmS, TXpower, WAIT_TX);
  ...
  Serial.println();
  Serial.print(F("Average Range Result "));
...
void display_screen1()
{
  ...
  //disp.setCursor(0, 6);
  //disp.print(F("Raw "));
  //disp.print(range_result_average);
}
#endif
...
void setup()
{
  ...
  LT.setupRanging(Frequency, Offset, SpreadingFactor, Bandwidth, CodeRate, Calibration, RANGING_MASTER);
