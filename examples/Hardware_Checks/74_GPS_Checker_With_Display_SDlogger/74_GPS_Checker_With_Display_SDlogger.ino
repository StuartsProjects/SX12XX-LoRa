/*******************************************************************************************************
  lora Programs for Arduino - Copyright of the author Stuart Robinson - 03/06/20
...
/*******************************************************************************************************
  ...
  74_GPS_Checker_With_Display_SDlogger Starting
  Initializing SD card
  Card initialized
  Writing to /Log0022.txt
...
#include "SPI.h"
#include "SdFat.h"                                 //get library here >  https://www.arduinolibraries.info/libraries/sd-fat
SdFat SD;
...
void setup()
{
  ...
  Serial.println(F("74_GPS_Checker_With_Display_SDlogger Starting"));
  Serial.println();
